...
<div class="row-sm align-items-center">
	<div class="col-lg-4-24 col-sm-3">
        <a class="navbar-brand" href="#"><img class="logo" src="<?php echo base_url('assets/images/logos/logo-alibaba.png');?>" alt="alibaba style e-commerce html template file" title="alibaba e-commerce html css theme"></a>
    </div>
